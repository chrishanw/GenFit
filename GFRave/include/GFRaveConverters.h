...
namespace genfit {
  ...
  // RAVE to ROOT
  ROOT::Math::XYZVector Point3DToXYZVector(const rave::Point3D&);
  ROOT::Math::XYZVector Vector3DToXYZVector(const rave::Vector3D&);
  ...
  // ROOT to RAVE
  rave::Point3D XYZVectorToPoint3D(const ROOT::Math::XYZVector &);
