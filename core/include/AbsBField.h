...
public:
   ...
   * unnecessary ROOT::Math::XYZVector instantiations.
   */
   ...
   * Override this in your concrete implementation.
   */
  virtual void get(const double& posX, const double& posY, const double& posZ, double& Bx, double& By, double& Bz) const { const ROOT::Math::XYZVector& B(this->get(ROOT::Math::XYZVector(posX, posY, posZ))); Bx = B.X(); By = B.Y(); Bz = B.Z(); }
